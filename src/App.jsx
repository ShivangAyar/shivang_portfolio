  ...
  return (
    <div className="bg-[#030305] text-gray-200 antialiased selection:bg-[#00E5FF] selection:text-black font-sans scroll-smooth relative min-h-screen overflow-x-hidden flex flex-col">
      ...
      <div className="relative z-30 w-full flex-grow flex flex-col">
        ...
        {/* HERO */}
        <section className="max-w-7xl mx-auto px-6 pt-48 pb-20 min-h-screen flex items-center pointer-events-none relative">
          <div className="absolute top-1/2 left-0 w-96 h-96 bg-[#00E5FF]/20 rounded-full blur-[150px] -z-10 mix-blend-screen"></div>
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: "easeOut" }} className="flex flex-col items-start pointer-events-auto max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <a href="/resume.pdf" target="_blank" className="bg-transparent border border-white/20 text-white px-10 py-5 text-xs font-bold tracking-[0.3em] uppercase hover:bg-white hover:text-black transition-all duration-500">
                Get Resume ↓
              </a>
            </div>
          </motion.div>
        ...
        <section id="about" className="max-w-7xl mx-auto px-6 py-32 flex flex-col justify-center pointer-events-none relative">
          <div className="pointer-events-auto grid grid-cols-1 lg:grid-cols-12 gap-20">
            ...
            <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="lg:col-span-5 flex flex-col justify-center">
              ...
              <div className="flex gap-4 w-full">
                <div className="bg-[#0A0A12]/60 backdrop-blur-xl border border-white/5 p-6 w-1/2 rounded-2xl text-center hover:border-[#00E5FF]/50 transition-colors shadow-2xl">
                ...
                <div className="bg-[#0A0A12]/60 backdrop-blur-xl border border-white/5 p-6 w-1/2 rounded-2xl text-center hover:border-[#FF3366]/50 transition-colors shadow-2xl">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="lg:col-span-7">
              ...
              <div className="border-l-2 border-gray-800/50 ml-4 space-y-12">
                
                <div className="relative pl-10 group">
                  <div className="absolute -left-[18px] top-2 w-8 h-8 rounded-full bg-[#030305] border border-[#00E5FF] flex items-center justify-center group-hover:bg-[#00E5FF] transition-all duration-500 shadow-[0_0_15px_rgba(0,229,255,0.5)]">
                    <span className="text-[10px] group-hover:text-[#030305] text-[#00E5FF]">🎓</span>
                  </div>
                  <div className="bg-[#0A0A12]/40 backdrop-blur-xl border border-white/5 p-8 rounded-2xl hover:border-[#00E5FF]/30 transition-all shadow-xl hover:-translate-y-1">
                    ...
                    <h3 className="text-2xl font-bold text-white tracking-tight mb-2">Adv. Dip. Computer Programming</h3>
                ...
                <div className="relative pl-10 group">
                  <div className="absolute -left-[18px] top-2 w-8 h-8 rounded-full bg-[#030305] border border-[#A855F7] flex items-center justify-center group-hover:bg-[#A855F7] transition-all duration-500">
                    <span className="text-[10px] group-hover:text-[#030305] text-[#A855F7]">💻</span>
                  </div>
                  <div className="bg-[#0A0A12]/40 backdrop-blur-xl border border-white/5 p-8 rounded-2xl hover:border-[#A855F7]/30 transition-all shadow-xl hover:-translate-y-1">
                    <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-4">
                ...
                <div className="relative pl-10 group">
                  <div className="absolute -left-[18px] top-2 w-8 h-8 rounded-full bg-[#030305] border border-[#FF3366] flex items-center justify-center group-hover:bg-[#FF3366] transition-all duration-500">
                    <span className="text-[10px] group-hover:text-[#030305] text-[#FF3366]">⚙️</span>
                  </div>
                  <div className="bg-[#0A0A12]/40 backdrop-blur-xl border border-white/5 p-8 rounded-2xl hover:border-[#FF3366]/30 transition-all shadow-xl hover:-translate-y-1">
                    <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-4">
                      <span className="text-[10px] text-gray-400 font-bold tracking-[0.2em] uppercase">2020 - 2021</span>
                    </div>
                    <h3 className="text-2xl font-bold text-white tracking-tight mb-2">Operations Leadership</h3>
                    <p className="text-[#FF3366] font-medium text-sm mb-4">Industrial Linings Ltd. | Chingola, Zambia</p>
                    <p className="text-gray-400 font-light text-base leading-relaxed">Supervised teams and modernized inventory tracking databases prior to relocating for software engineering.</p>
                  </div>
                </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-20 pointer-events-none">
          <div className="pointer-events-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl border border-white/5 p-10 rounded-3xl text-center hover:border-[#00E5FF]/40 hover:-translate-y-2 transition-all duration-300 group shadow-xl">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl border border-white/5 p-10 rounded-3xl text-center hover:border-[#A855F7]/40 hover:-translate-y-2 transition-all duration-300 group shadow-xl">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl border border-white/5 p-10 rounded-3xl text-center hover:border-[#FF3366]/40 hover:-translate-y-2 transition-all duration-300 group shadow-xl">
                <div className="text-5xl mb-6 grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300">🌍</div>
        ...
        {/* MILESTONES & COMPETENCIES (Now 6 Columns/Cards) */}
        <section id="skills" className="max-w-7xl mx-auto px-6 py-32 pointer-events-none relative">
          <div className="absolute top-1/4 right-0 w-96 h-96 bg-[#FF3366]/10 rounded-full blur-[150px] -z-10 mix-blend-screen"></div>
          <div className="pointer-events-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-32">
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-8 rounded-2xl border border-white/5 flex flex-col hover:border-[#00E5FF]/30 transition-all shadow-lg group">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-8 rounded-2xl border border-white/5 flex flex-col hover:border-[#A855F7]/30 transition-all shadow-lg group">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-8 rounded-2xl border border-white/5 flex flex-col hover:border-[#FF3366]/30 transition-all shadow-lg group">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-8 rounded-2xl border border-white/5 flex flex-col hover:border-yellow-500/30 transition-all shadow-lg group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {/* Card 1 */}
              <div className="bg-[#0A0A12]/40 backdrop-blur-xl p-8 rounded-3xl border border-white/5 hover:border-[#00E5FF]/30 transition-all shadow-xl group">
              ...
              {/* Card 2 */}
              <div className="bg-[#0A0A12]/40 backdrop-blur-xl p-8 rounded-3xl border border-white/5 hover:border-[#A855F7]/30 transition-all shadow-xl group">
              ...
              {/* Card 3 */}
              <div className="bg-[#0A0A12]/40 backdrop-blur-xl p-8 rounded-3xl border border-white/5 hover:border-[#FF3366]/30 transition-all shadow-xl group">
              ...
              {/* Card 5 */}
              <div className="bg-[#0A0A12]/40 backdrop-blur-xl p-8 rounded-3xl border border-white/5 hover:border-yellow-500/30 transition-all shadow-xl group">
        ...
        <section id="projects" className="max-w-7xl mx-auto px-6 py-32 pointer-events-none">
          <div className="pointer-events-auto">
            <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-6xl font-black text-white mb-16 tracking-tighter">System <span className="text-[#A855F7]">Builds.</span></motion.h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projects.map((proj, idx) => (
                <div key={idx} className="bg-[#0A0A12]/60 backdrop-blur-xl p-10 rounded-3xl border border-white/5 transition-all duration-500 group relative overflow-hidden shadow-2xl hover:-translate-y-2 hover:border-white/20">
                  ...
                  <p className="text-gray-400 mb-8 leading-relaxed text-sm font-light h-24">{proj.desc}</p>
        ...
        <section id="contact" className="w-full bg-[#0A0A12]/90 backdrop-blur-2xl border-t border-white/5 pt-32 pb-16 pointer-events-none mt-20 relative z-30">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-64 bg-[#00E5FF]/5 rounded-full blur-[100px] -z-10 mix-blend-screen pointer-events-none"></div>
          <div className="max-w-4xl mx-auto px-6 pointer-events-auto flex flex-col items-center">
            <div className="bg-[#030305] border border-white/5 p-12 rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.5)] w-full text-center relative overflow-hidden group">
              ...
              <div className="flex items-center justify-center gap-3 mb-12 bg-white/5 w-max mx-auto px-8 py-4 rounded-full border border-white/5 shadow-inner">
