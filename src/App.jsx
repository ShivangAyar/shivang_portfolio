  ...
  return (
    <div className="bg-[#030305] text-gray-200 antialiased selection:bg-[#00E5FF] selection:text-black font-sans scroll-smooth relative min-h-screen overflow-x-hidden flex flex-col">
      ...
      <div className="relative z-30 w-full flex-grow flex flex-col">
              ...
              <div className="border-l-2 border-gray-800/50 ml-2 sm:ml-4 space-y-10 md:space-y-12">
                ...
                <div className="relative pl-6 sm:pl-10 group">
                  ...
                  <div className="bg-[#0A0A12]/40 backdrop-blur-xl border border-white/5 p-6 sm:p-8 rounded-2xl hover:border-[#A855F7]/30 transition-all shadow-xl hover:-translate-y-1">
                    ...
                    <p className="text-gray-400 font-light text-sm sm:text-base leading-relaxed">Built a foundation in algorithms, computation theory, and core software engineering principles.</p>
                  </div>
                </div>
                <div className="relative pl-6 sm:pl-10 group">
        ...
        <section id="skills" className="max-w-7xl mx-auto px-6 py-20 md:py-32 pointer-events-none relative">
          <div className="pointer-events-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-24 md:mb-32">
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-6 rounded-2xl border border-white/5 flex flex-col hover:border-[#00E5FF]/30 transition-all shadow-lg group">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-6 rounded-2xl border border-white/5 flex flex-col hover:border-[#A855F7]/30 transition-all shadow-lg group">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-6 rounded-2xl border border-white/5 flex flex-col hover:border-[#FF3366]/30 transition-all shadow-lg group">
              ...
              <div className="bg-[#0A0A12]/60 backdrop-blur-xl p-6 rounded-2xl border border-white/5 flex flex-col hover:border-yellow-500/30 transition-all shadow-lg group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: "Programming", icon: "💻", skills: [{name: "Java", val: "90%"}, {name: "Python", val: "85%"}, {name: "JavaScript", val: "85%"}, {name: "C#", val: "70%"}] },
                { title: "Frontend Dev", icon: "🖥️", skills: [{name: "React.js", val: "90%"}, {name: "HTML5/CSS3", val: "95%"}, {name: "Tailwind CSS", val: "85%"}, {name: "Bootstrap", val: "80%"}] },
                { title: "Backend & APIs", icon: "⚙️", skills: [{name: "Node.js", val: "85%"}, {name: "Express.js", val: "85%"}, {name: "RESTful APIs", val: "90%"}, {name: "WebSockets", val: "75%"}] },
                { title: "Databases", icon: "🗄️", skills: [{name: "MongoDB", val: "85%"}, {name: "MySQL", val: "90%"}, {name: "PostgreSQL", val: "75%"}, {name: "NoSQL Design", val: "85%"}] },
                { title: "Data & Analytics", icon: "📊", skills: [{name: "Power BI", val: "90%"}, {name: "DAX", val: "85%"}, {name: "Star Schema", val: "85%"}, {name: "ETL Processes", val: "80%"}] },
                { title: "DevOps & Cloud", icon: "☁️", skills: [{name: "Git / GitHub", val: "95%"}, {name: "AWS (EC2/S3)", val: "80%"}, {name: "Docker", val: "75%"}, {name: "CI/CD & Vercel", val: "85%"}] }
              ].map((card, idx) => (
                <div key={idx} className="bg-[#0A0A12]/40 backdrop-blur-xl p-6 sm:p-8 rounded-3xl border border-white/5 hover:border-white/20 transition-all shadow-xl group">
                  <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-3 tracking-tight"><span>{card.icon}</span> {card.title}</h3>
                  <div className="space-y-5">
                    {card.skills.map((s, i) => (
                      <div key={i}>
                        <div className="flex justify-between text-[10px] font-bold tracking-[0.1em] text-gray-400 uppercase mb-2"><span>{s.name}</span><span className="text-white">{s.val}</span></div>
                        <div className="w-full bg-white/5 rounded-full h-1 overflow-hidden"><div className="bg-white h-1 rounded-full w-0 group-hover:w-[90%] transition-all duration-1000 ease-out" style={{ width: s.val }}></div></div>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          <div className="pointer-events-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {projects.map((proj, idx) => (
                <div key={idx} className="bg-[#0A0A12]/60 backdrop-blur-xl p-6 sm:p-10 rounded-3xl border border-white/5 transition-all duration-500 group relative overflow-hidden shadow-2xl hover:-translate-y-2">
        ...
        {/* FIXED FOOTER - COLOR MATCHED TO PREVENT CUTOFF */}
        <section id="contact" className="w-full bg-[#030305] pt-24 pb-16 pointer-events-none relative z-30 border-t border-white/5">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 pointer-events-auto flex flex-col items-center">
            <div className="bg-[#030305] border border-white/5 p-8 sm:p-12 rounded-3xl sm:rounded-[2.5rem] shadow-[0_0_50px_rgba(0,0,0,0.5)] w-full text-center relative overflow-hidden group">
              ...
              <p className="text-gray-400 mb-10 font-light text-base sm:text-lg">I typically respond within 24 hours. For urgent matters, initialize a secure ping via email or LinkedIn.</p>
