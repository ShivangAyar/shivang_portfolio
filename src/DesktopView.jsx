    ...
    <div className="bg-[#010102] text-gray-200 antialiased selection:bg-[#00E5FF] selection:text-black font-sans scroll-smooth relative min-h-screen overflow-x-hidden">
      ...
      <div className="relative z-30 w-full flex flex-col">
        ...
        <section id="about" className="max-w-7xl mx-auto px-6 py-40 w-full relative">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-5">
              ...
              <p className="text-gray-400 mb-8 text-xl font-light leading-relaxed">Born in Zambia, operating in Ottawa. My approach to engineering is purely objective: Build, Optimize, and Master.</p>
            </div>
            <div className="lg:col-span-7 space-y-12 border-l-2 border-[#00E5FF]/20 ml-4 relative">
              {[ 
                {i:"🎓", y:"2024 - Present", t:"Algonquin College", p:"Advanced Diploma in Computer Programming.", c:"#00E5FF"},
                {i:"💻", y:"2021 - 2023", t:"Fraser International College", p:"Computer Science Pathway.", c:"#A855F7"}
              ].map((step, idx) => (
                <div key={idx} className="relative pl-12 group">
                  <div className="absolute -left-[18px] top-2 w-8 h-8 rounded-full bg-[#030305] border flex items-center justify-center shadow-[0_0_15px_rgba(0,229,255,0.2)]" style={{ borderColor: step.c }}>{step.i}</div>
        ...
        <section id="skills" className="max-w-7xl mx-auto px-6 py-20 w-full">
            <h2 className="text-6xl md:text-7xl font-black text-white mb-16 tracking-tighter text-center uppercase">Technical <span className="text-[#00E5FF]">Arsenal.</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[ 
                   { t: "Languages", i: "💻", s: [{n: "Java", v: "90%"}, {n: "Python", v: "85%"}, {n: "JavaScript", v: "85%"}] },
                   { t: "Frontend", i: "🖥️", s: [{n: "React", v: "90%"}, {n: "HTML/CSS", v: "95%"}, {n: "Tailwind", v: "85%"}] },
                   { t: "Backend", i: "⚙️", s: [{n: "Node.js", v: "85%"}, {n: "Express", v: "85%"}, {n: "REST APIs", v: "90%"}] },
                   { t: "Databases", i: "🗄️", s: [{n: "MongoDB", v: "85%"}, {n: "MySQL", v: "90%"}, {n: "PostgreSQL", v: "75%"}] },
                   { t: "Analytics", i: "📊", s: [{n: "Power BI", v: "90%"}, {n: "DAX", v: "85%"}, {n: "Star Schema", v: "85%"}] },
                   { t: "DevOps", i: "☁️", s: [{n: "Git", v: "95%"}, {n: "AWS", v: "80%"}, {n: "Docker", v: "75%"}] }
                ].map((card, idx) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((p, i) => (
                    <motion.div 
                        ...
                        whileHover={{ y: -15, borderColor: `${p.color}30` }}
                    >
                        <h3 className="text-3xl font-bold text-white mb-6 leading-tight tracking-tighter uppercase">{p.title}</h3>
                        <p className="text-gray-400 text-lg font-light mb-auto">{p.desc}</p>
        ...
        <section className="max-w-7xl mx-auto px-6 py-40 flex flex-col items-center w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
              {[ {i:"🏋️‍♂️",t:"Discipline",d:"6-day compound split focus."},
                 {i:"🎮",t:"Logic",d:"Competitive shooters & tuning."},
                 {i:"🌍",t:"Equilibrium",d:"Hiking & trail exploration."}
              ].map((h,x)=>(
                <div key={x} className="bg-[#0A0A12]/40 border border-white/5 p-12 rounded-[2.5rem] text-center hover:border-white/20 transition-all shadow-2xl group">
                  <div className="text-7xl mb-8 group-hover:scale-105 transition-all">{h.i}</div>
        ...
        <footer id="contact" className="w-full py-60 flex items-center justify-center relative">
          <div className="max-w-5xl mx-auto px-6 flex flex-col items-center w-full">
            <div className="bg-[#010102]/80 backdrop-blur-3xl border border-white/10 p-16 md:p-24 rounded-[4rem] text-center relative overflow-hidden group w-full">
            ...
            <p className="mt-40 text-center text-[11px] font-black tracking-[0.8em] text-gray-800 uppercase">© 2026 SHIVANG AYAR. ARCHITECTED WITH INTENT.</p>
          </div>
        </footer>
      </div>
    </div>
